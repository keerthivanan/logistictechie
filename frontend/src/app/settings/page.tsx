...
import { Settings as SettingsIcon, ChevronLeft, User, Building2, Phone, Image, Check, AlertCircle, Loader2 } from 'lucide-react'
        ...
        <div className="min-h-screen bg-[#080808] text-white">
            ...
            <div className="max-w-3xl mx-auto px-6 pt-28 pb-16">
                ...
                <div className="flex items-center gap-3 mb-8">
                    ...
                    <div>
                        <h1 className="text-lg font-bold text-white tracking-tight">Account Settings</h1>
                        <p className="text-xs text-zinc-500">Manage your profile information</p>
                    </div>
                </div>
                ...
                <div className="space-y-4">
                    ...
                    <div className="bg-zinc-950 border border-white/5 rounded-2xl p-6">
                        <h2 className="text-xs font-bold text-zinc-500 uppercase tracking-widest mb-6">Profile Information</h2>

                        {/* Avatar preview */}
                        <div className="flex items-center gap-4 mb-6">
                            <Avatar src={avatarUrl} name={fullName} size="lg" className="border-white/10 flex-shrink-0" />
                            <div className="flex-1">
                                <p className="text-xs font-medium text-white mb-0.5">{fullName || 'Your Name'}</p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label className="block text-[10px] font-medium text-zinc-500 mb-1.5">Full Name</label>
                            ...
                            <div>
                                <label className="block text-[10px] font-medium text-zinc-500 mb-1.5">Company Name</label>
                                <div className="relative">
                            ...
                            <div>
                                <label className="block text-[10px] font-medium text-zinc-500 mb-1.5">Phone Number</label>
                                <div className="relative">
                    ...
                    {/* Account Info */}
                    <div className="bg-zinc-950 border border-white/5 rounded-2xl p-6">
                        <h2 className="text-xs font-bold text-zinc-500 uppercase tracking-widest mb-4">Account Info</h2>
