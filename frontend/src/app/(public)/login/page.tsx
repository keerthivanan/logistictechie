    ...
    return (
        <div className="space-y-16">
            <div className="flex justify-between items-center">
                <h2 className="text-4xl font-light text-white uppercase tracking-tight italic">Access_Port</h2>
            ...
            <form onSubmit={handleCredentialsLogin} className="space-y-12">
                <div className="space-y-4">
                    ...
                    <input
                        ...
                        required
                        className="bg-transparent border-b border-white/10 w-full py-4 text-2xl font-light text-white italic outline-none focus:border-white transition-all placeholder:text-zinc-900"
                ...
                <div className="flex justify-between items-center text-[9px] font-black uppercase tracking-widest">
                    <span className="text-zinc-800 cursor-default" title="Contact support to recover access">
                        LOST_KEY? → CONTACT_SUPPORT
                    </span>
                </div>
                ...
                <div className="space-y-6">
                    ...
                    >
                        {isLoading ? (t('auth.login.authenticating')?.toUpperCase() || "AUTHENTICATING") : (t('auth.login.initSession')?.toUpperCase() || "INITIALIZE_SESSION")}
                    </button>
            ...
            <div className="container max-w-[1400px] mx-auto px-8 py-48">
                ...
                >
                    <div>
                        ...
                        <h1 className="arch-heading italic">{t('audit.welcomeBack').split(' ')[0]} <br />{t('audit.welcomeBack').split(' ').slice(1).join(' ')}</h1>
                    </div>
