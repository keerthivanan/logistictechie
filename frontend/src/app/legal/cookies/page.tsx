...
export default function CookiePage() {
    ...
    const sections = [
        { num: '01', title: t('legal.cookies.s1.title'), body: t('legal.cookies.s1.body') },
        { num: '02', title: t('legal.cookies.s2.title'), body: t('legal.cookies.s2.body') },
        { num: '03', title: t('legal.cookies.s3.title'), body: t('legal.cookies.s3.body') },
        { num: '04', title: t('legal.cookies.s4.title'), body: t('legal.cookies.s4.body') },
        { num: '05', title: t('legal.cookies.s5.title'), body: t('legal.cookies.s5.body') },
        { num: '06', title: t('legal.cookies.s6.title'), body: t('legal.cookies.s6.body') },
        { num: '07', title: t('legal.cookies.s7.title'), body: t('legal.cookies.s7.body') },
        { num: '08', title: t('legal.cookies.s8.title'), body: t('legal.cookies.s8.body') },
    ]
        ...
        <div className="min-h-screen bg-black text-white font-inter selection:bg-white selection:text-black">
            ...
            <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20">
                ...
                <div className="mb-10">
                    ...
                    <p className="text-xs text-zinc-500 font-inter">{t('legal.cookies.sub')}</p>
