...
export default function PrivacyPage() {
    ...
    const sections = [
        { num: '01', title: t('legal.privacy.s1.title'), body: t('legal.privacy.s1.body') },
        { num: '02', title: t('legal.privacy.s2.title'), body: t('legal.privacy.s2.body') },
        { num: '03', title: t('legal.privacy.s3.title'), body: t('legal.privacy.s3.body') },
        { num: '04', title: t('legal.privacy.s4.title'), body: t('legal.privacy.s4.body') },
        { num: '05', title: t('legal.privacy.s5.title'), body: t('legal.privacy.s5.body') },
        { num: '06', title: t('legal.privacy.s6.title'), body: t('legal.privacy.s6.body') },
        { num: '07', title: t('legal.privacy.s7.title'), body: t('legal.privacy.s7.body') },
        { num: '08', title: t('legal.privacy.s8.title'), body: t('legal.privacy.s8.body') },
    ]
        ...
        <div className="min-h-screen bg-black text-white font-inter selection:bg-white selection:text-black">
            ...
            <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20">
                ...
                <div className="mb-10">
                    ...
                    <p className="text-xs text-zinc-500 font-inter">{t('legal.privacy.sub')}</p>
