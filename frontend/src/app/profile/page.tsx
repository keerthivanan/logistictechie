...
export default function ProfilePage() {
    ...
    const roleLabel = user.role === 'forwarder' ? 'Freight Partner' : user.role === 'admin' ? 'Administrator' : 'Shipper'
                    ...
                    <div className="flex items-start gap-6">
                        ...
                        <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-3 flex-wrap mb-1">
                                <h1 className="text-xl font-bold text-white">{user.name || 'No name set'}</h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    ...
                    <div className="bg-zinc-950 border border-white/5 rounded-2xl p-6 space-y-4">
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <p className="text-[10px] text-zinc-600 font-medium">Full Name</p>
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <p className="text-[10px] text-zinc-600 font-medium">Email</p>
                            ...
                            {user.company_name && (
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-[10px] text-zinc-600 font-medium">Company</p>
                            ...
                            {user.phone_number && (
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-[10px] text-zinc-600 font-medium">Phone</p>
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <p className="text-[10px] text-zinc-600 font-medium">Account Role</p>
                    ...
                    <div className="bg-zinc-950 border border-white/5 rounded-2xl p-6">
                        <h2 className="text-xs font-bold text-zinc-500 uppercase tracking-widest mb-4">
                            {user.role === 'forwarder' ? 'Bid Summary' : 'Shipment Summary'}
                        </h2>
                        {statsError ? (
                            <p className="text-xs text-zinc-600 mt-2">Could not load stats. Please refresh.</p>
                        ) : (
