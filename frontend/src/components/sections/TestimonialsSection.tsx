...
const testimonials = [
    {
        ...
        quote: "CargoLink has an impressive set of features, super competitive pricing, and the best tracking accuracy in the industry. The UI is very intuitive and the smart use of small diagrams, sparklines and graphs make it easy to follow the progress.",
    },
    {
        name: "Steffan Fisher",
    ...
    },
    {
        name: "Mathew Cooper",
        role: "Import Manager",
        quote: "One of the best things about CargoLink is the ability to send daily reports that are extremely customizable. Some of my clients have different levels of understanding, so this gives you the ability to showcase brilliant reports.",
    },
    {
        name: "Marvin McKinney",
        role: "CEO, FastShip",
        quote: "CargoLink is truly amazing and delivers what it promises! I signed up two years ago and haven't looked back. It is definitely giving its rivals a run for their money! The way this platform organizes information is unmatched.",
    },
    {
        name: "Ethan Sullivan",
