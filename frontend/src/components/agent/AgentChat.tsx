...
export default function AgentChat() {
    ...
    return (
        <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
            ...
            {/* Preview bubble — Intercom style */}
            {showPreview && !open && !dismissed && (
                <div
                    className="flex items-start gap-3 bg-white rounded-2xl shadow-2xl px-4 py-3 max-w-[280px] cursor-pointer hover:shadow-xl transition-all animate-fade-in"
                    onClick={openChat}
                >
                    {/* Avatar */}
            ...
            {open && (
                <div className="w-[370px] h-[530px] bg-white rounded-2xl shadow-2xl flex flex-col overflow-hidden border border-zinc-100">
                    ...
                    {/* Header */}
                    <div className="bg-gradient-to-br from-zinc-900 to-black px-5 py-4">
