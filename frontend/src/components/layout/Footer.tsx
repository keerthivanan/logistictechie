            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="py-16 flex flex-col items-center text-center">
                    ...
                    <Link href="/" className="flex items-center mb-4 group">
                        <img src="/cargolink-white.png" alt="CargoLink" className="h-12 md:h-16 w-auto object-contain opacity-90 group-hover:opacity-100 transition-opacity" />
                    </Link>
                ...
                {/* Middle — link columns */}
                <div className="py-10 md:py-14 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-6 md:gap-10 border-b border-white/[0.05]">
                    {columns.map((col) => (
                        <div key={col.heading}>
